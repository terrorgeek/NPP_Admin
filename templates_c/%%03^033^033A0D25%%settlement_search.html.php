<?php /* Smarty version 2.6.24, created on 
         compiled from settlement/settlement_search.html */ ?>
...
<script language="javascript">
	...
	function submit_form()
	{
		...
		if(cp_name_or_id.match(/[0-9a-zA-Z]/))
		{
			flag=true;
		}
		else
...
,您好！<br />
		...
		<div id="main-content"> <!-- Main Content Section with everything -->			
			...
			<div class="content-box"><!-- Start Content Box -->
					...
					<div id="tab_control">
						<ul id="tab_tag">
							<li id="li_1" class="li_1"><h3>交易日报查询</h3></li>
				...
				<div class="content-box-header3" id = "search_bars" style="height: 100px;">
					<br>
					<form name = "settlement_search1" id = "settlement_search1" action="settlement_search.php" method="post" >					
					<p>
						    &nbsp;&nbsp;&nbsp;&nbsp;
						    <input type="checkbox" checked="checked" disabled="true" name="checkbox_time" id="checkbox_time" />
					 	          <b>时间</b><input type="text" name="start_time" id="start_time" value="<?php echo $this->_tpl_vars['start_time']; ?>
" />至
					 	        <input type="text" name="end_time" id="end_time" value="<?php echo $this->_tpl_vars['end_time']; ?>
" />
							&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="checkbox" checked="checked" disabled="true" name="checkbox_cp" id="checkbox_cp" />
							      <b>开发者名称/ID:</b><input type="text" name="cp_name_or_id" id="cp_name_or_id" value="<?php echo $this->_tpl_vars['cp_name_or_id']; ?>
" />
							&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="checkbox" name="checkbox_payment_channel" id="checkbox_payment_channel" <?php echo $this->_tpl_vars['checkbox_payment_channel']; ?>
 />
							      <b>支付渠道</b>
							...
							<span><input type="button" class="button" value="查询" onclick="submit_form()" /></span>	
