...
,您好！<br />
		...
		<div id="main-content"> <!-- Main Content Section with everything -->			
			...
			<!-- Page Head -->
			<p id="page-intro">登录名：<?php echo $this->_tpl_vars['username']; ?>
</p>
			<p id="page-intro">管理员级别：<?php echo $this->_tpl_vars['rolename']; ?>
</p>
			<p id="page-intro">上次登录时间：<?php echo $this->_tpl_vars['lasttime']; ?>
</p>
			<p id="page-intro">版本号：<?php echo $this->_tpl_vars['version']; ?>
</p>
							...
							<tfoot>
								<tr>
									...
									<div class="pagination">
											<a href="../log/admin_log.php"  class="STYLE1">查看更多>></a>									  </div> 
									<!-- End .pagination -->
										<div class="clear"></div>
								  </td>
								</tr>
