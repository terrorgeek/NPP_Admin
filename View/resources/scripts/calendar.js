...
//	(this.weekNumbers) && ++title_length;
	...
	this._nav_py = hh("<img id=objyprev src=\"../../View/resources/images/yprev.gif\">", 1, -2);
...
//	this._nav_py = hh("&#x00ab;", 1, -2);
	...
	//	this._nav_ny = hh("&#x00bb;", 1, 2);
	this._nav_ny = hh("<img id=objynext src=\"../../View/resources/images/ynext.gif\">", 1, 2);
	this._nav_ny.width = 25;
	this._nav_ny.ttip = Calendar._TT["NEXT_YEAR"];

//	this._nav_pm = hh("&#x2039;", 1, -1);
	this._nav_pm = hh("<img id=objmprev src=\"../../View/resources/images/mprev.gif\">", 1, -1);
	this._nav_pm.width = 25;
	this._nav_pm.ttip = Calendar._TT["PREV_MONTH"];
	
	this.title2 = hh("", 1, 300);
	this.title2.className = "title";
	this.title2.width = 32;
	
//	this._nav_nm = hh("&#x203a;", 1, 1);
	this._nav_nm = hh("<img id=objmnext src=\"../../View/resources/images/mnext.gif\">", 1, 1);
...
//	this._nav_now.ttip = Calendar._TT["GO_TODAY"];
	...
	if (this.isPopup) {
		...
		var td_close = hh("<img id=objclose src=\"../../View/resources/images/close.gif\">", 1, 200);
